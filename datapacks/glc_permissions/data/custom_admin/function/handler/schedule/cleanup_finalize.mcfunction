...
execute if score #delete_count gulce_id matches 1.. run tellraw @a[tag=gulce_debug] ["",{"text":"[DEBUG] ","color":"gray"},{"text":"🗑️ ","color":"red"},{"score":{"name":"#delete_count","objective":"gulce_id"},"color":"yellow"},{"text":" zamanlama silindi","color":"gray"}]
