...
# v2.5.0-fix: Yeni timer başlangıç değerleri
...
# v2.5.0-fix: Welcome config yoksa varsayılan oluştur
...
# v2.5.0-fix: Auto announce config yoksa oluştur
...
# v2.5.0-fix: VIP teleport locations yoksa spawn varsayılanı ekle
