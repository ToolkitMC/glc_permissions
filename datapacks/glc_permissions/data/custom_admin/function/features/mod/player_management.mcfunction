...
# 1. YETKİ KONTROLÜ
execute unless score @s gulce_permission_level matches 3.. run tellraw @s {"text":"❌ Bu özellik için MOD(+) yetkisi gerekiyor!","color":"red"}
