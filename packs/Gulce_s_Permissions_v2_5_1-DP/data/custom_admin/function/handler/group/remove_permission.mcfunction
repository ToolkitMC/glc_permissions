...
# Feedback
execute if entity @s[tag=glc.lang_tr] run tellraw @s [{text:"[GULCE] ",color:"gold",bold:true},{text:"🗑️ İzin silindi",color:"red"}]
execute if entity @s[tag=glc.lang_en] run tellraw @s [{text:"[GULCE] ",color:"gold",bold:true},{text:"🗑️ İzin silindi",color:"red"}]
...
# Log
$execute as @a[tag=glc.lang_tr,tag=gulce_admin] run tellraw @s ['',{text:"[GULCE] ",color:"gold",bold:true},{text:"İzin silindi: ",color:"gray"},{text:"$(group_id)",color:"yellow"},{text:" ← ",color:"gray"},{text:"$(permission)",color:"red"}]
$execute as @a[tag=glc.lang_en,tag=gulce_admin] run tellraw @s ['',{text:"[GULCE] ",color:"gold",bold:true},{text:"İzin silindi: ",color:"gray"},{text:"$(group_id)",color:"yellow"},{text:" ← ",color:"gray"},{text:"$(permission)",color:"red"}]