...
# Dialog tabanlı (popup kabul) + NameTag kısayolları (popup-free)
# ═══════════════════════════════════════════════════
...
# NameTag: Uyar (trigger → popup yok)
...
# NameTag: Sorgula (trigger → popup yok)
...
# NameTag: Affet (trigger → popup yok)
