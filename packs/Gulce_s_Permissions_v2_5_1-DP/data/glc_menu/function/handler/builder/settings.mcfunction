...
execute if entity @s[tag=glc.lang_tr] run data modify storage glc:ui ui.actions append value {label:"🌐 Dil: Türkçe",action:{type:"minecraft:show_dialog",dialog:{type:"minecraft:multi_action",title:"🌐 Dil Seçimi",body:{type:"minecraft:plain_message",contents:"Dil değiştirmek için aşağıdan seçim yapın:"},inputs:[{type:"minecraft:single_option",key:'lang',label:"Dil",options:[{id:'tr',display:"🇹🇷 Türkçe"},{id:'en',display:"🇬🇧 English"},{id:'de',display:"🇩🇪 Deutsch"}]}],actions:[{label:"✅ Uygula",action:{type:"minecraft:dynamic/run_command",template:"/function custom_admin:util/lang/set {lang:\"$(lang)\"}"}}]}}}
...
execute unless entity @s[tag=glc.lang_tr] unless entity @s[tag=glc.lang_en] run data modify storage glc:ui ui.actions append value {label:"🌐 Dil: Türkçe",action:{type:"minecraft:show_dialog",dialog:{type:"minecraft:multi_action",title:"🌐 Dil Seçimi",body:{type:"minecraft:plain_message",contents:"Dil değiştirmek için aşağıdan seçim yapın:"},inputs:[{type:"minecraft:single_option",key:'lang',label:"Dil",options:[{id:'tr',display:"🇹🇷 Türkçe"},{id:'en',display:"🇬🇧 English"},{id:'de',display:"🇩🇪 Deutsch"}]}],actions:[{label:"✅ Uygula",action:{type:"minecraft:dynamic/run_command",template:"/function custom_admin:util/lang/set {lang:\"$(lang)\"}"}}]}}}
